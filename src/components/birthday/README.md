...
| `music/music-dock.tsx`             | Corner sound button with equalizer and a brief song title.                                                                                                                                                      |
...
| `wishes/birthday-wishes.tsx`       | Warm chapter: letter by letter title, blessing paragraphs.                                                                                                                                                      |
| `wishes/rising-embers.tsx`         | Faint warm specks rising.                                                                                                                                                                                       |
| `finale/final-reveal.tsx`          | "But..." sequence, then the notebook and closing lines; replay link after a long while.                                                                                                                         |
